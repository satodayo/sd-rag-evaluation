...
single_turn_sample = SingleTurnSample(
    ...
    retrieved_contexts=["富士山は山梨県と静岡県に跨る活火山である。標高3776.12m、日本最高峰（剣ヶ峰）の独立峰で、その優美な風貌は日本国外でも日本の象徴として広く知られている。",
                        ...
                        "エベレストは、ヒマラヤ山脈にある世界最高峰の山である。山頂は、ネパールと中国・チベット自治区との国境上にある。"],
    response = "富士山は山梨県と静岡県に跨る活火山で、標高は3776.12mです。日本最高峰（剣ヶ峰）の独立峰で、垂曲線の山容を有した玄武岩質成層火山で構成されており、山頂部には浅間大神が鎮座するとされています。",
